...
final class Tax {
	...
	public function getRates($value, $tax_class_id) {
		...
		$tax_rate_data = array();
                ...
                // @SHILPI: SKIPP THE GST TAX IN CASE OF OUT OF INDIA SHIPMENT
              /*  if (isset($this->payment_address['country_id']) && $this->payment_address['country_id'] != 99) {
                    if (isset($tax_rates[90]))
                        unset($tax_rates[90]);

                    if (isset($tax_rates[91]))
                        unset($tax_rates[91]);

                    if (isset($tax_rates[92]))
                        unset($tax_rates[92]);
                    
                    if (isset($tax_rates[93]))
                        unset($tax_rates[93]);
                }*/
