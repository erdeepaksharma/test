...
<div id="cart" class="shortcut">
 <a class="shortcut_heading" href="<?php echo $cart; ?>" id="cart-total"><?php echo $text_items; ?></a>
  <div class="content">
      ...
      <table>
        <?php foreach ($products as $product) { ?>
         ...
         <?php echo $product['name']; ?>
            <?php echo $product['quantity']; ?>&nbsp;x&nbsp;<b><?php echo $product['price']; ?> (Free)</b>
            <div>
        ...
        <tr>
          ...
          <td class="remove border"><a title="<?php echo $button_remove; ?>" onclick="(getURLVar('route') == 'checkout/cart' || getURLVar('route') == 'checkout/checkout') ? location = 'index.php?route=checkout/cart&remove=<?php echo $product['key']; ?>' : $('#cart').load('index.php?route=module/cart&remove=<?php echo $product['key']; ?>' + ' #cart > * ' );"><span class="remove">x</span></a></td>
        </tr>
        <?php } } ?>
    ...
    <a class="button second" href="<?php echo $cart; ?>"><?php echo $text_cart; ?></a>
