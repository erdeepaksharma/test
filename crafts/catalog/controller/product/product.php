...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		// Customize Tray Redirection
		if($product_id==4237){
			header("Location:https://www.craftslane.com/index.php?route=customise/product&product_id=4237&category=Trays");
		}
...
$opres=$this->model_catalog_product->getProductOptionsPage($this->request->get['product_id']);
 

			foreach ($opres as $option) {
				...
				if ($option['type'] == 'select' || $option['type'] == 'radio' || $option['type'] == 'checkbox' || $option['type'] == 'image') {
					...
					foreach ($option['option_value'] as $option_value) {
						...
						//echo "<pre>"; print_r($option['option_value']); 
